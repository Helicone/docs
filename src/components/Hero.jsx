...
export function Hero() {
  ...
  const code = tabs[activeCodeTab].code;
  const codeLanguage = tabs[activeCodeTab].language;
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Access our APIs to easily automate image generation with Stable Diffusion.
              </p>
                      ...
                      >
                        <div
                          className={clsx(
                            ...
                            (tab === activeCodeTab) && 'bg-slate-800'
                          )}
                        >
                          {tab}
                        </div>
